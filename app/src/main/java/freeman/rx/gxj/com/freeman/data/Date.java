package freeman.rx.gxj.com.freeman.data;
...
public class Date {
    ...
    static {
        ...
        LAYOUTS = new int[]{R.layout.recyclerview_header1,
                R.layout.recyclerview_header2,
                R.layout.recyclerview_header3,
                R.layout.recyclerview_header4};
        mRandom = new Random();
        //取系统颜色集
